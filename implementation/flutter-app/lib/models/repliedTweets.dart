class RepliedTweets {
  ...
  RepliedTweets({this.documents});

  RepliedTweets.fromJson(Map<String, dynamic> json) {
...
class Documents {
  ...
  Documents.fromJson(Map<String, dynamic> json) {
    ...
    type = json['type'];
    reply = json['reply'];
    replyTimestamp = json['reply_timestamp'] != null
        ? new Timestamp.fromJson(json['reply_timestamp'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.replyTimestamp != null) {
      data['reply_timestamp'] = this.replyTimestamp.toJson();
    }
    return data;
  }
}
